...
// JPA entity for check-in sessions in the application
@Entity
@Table(name = "check_in_sessions")
public class CheckInSession {
    
    // Primary key for the CheckInSession entity; auto-generated by the database
    @Id
    ...
    // Current session status stored as a string from the SessionStatus enum
    @Enumerated(EnumType.STRING)
    @Column(name = "status", nullable = false, length = 30)
    private SessionStatus status;

    // Audit timestamps for the session record
    ...
    // Customer, responder, and related check-in methods/events for this session
